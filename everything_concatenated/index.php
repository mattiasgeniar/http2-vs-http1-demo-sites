...
<link rel="stylesheet" href="<?php echo DEMO_URL; ?>/css/one_css_to_rule_them_all.css" type="text/css" media="all" />
	<style type='text/css'>
          .no-break br {
...
<script type='text/javascript' src='<?php echo DEMO_URL; ?>js/one_js_to_rule_them_all.js'></script>
